...
{
  "$end", "error", "$undefined", "NUM", "DECLARE", "IDENTIFIER", "'-'",
  "'+'", "'*'", "'/'", "'^'", "NEG", "'\\n'", "'='", "'('", "')'",
...
{
      -7,    15,    -7,    -7,    -4,     3,    19,    -7,    19,    -7,
      48,    -7,    19,    19,    -7,    28,    19,    19,    19,    19,
      19,    -7,    55,    38,    -7,    -5,    -5,    -2,    -2,    -2,
      -7
};
...
{
      14,    11,    15,    18,    19,    20,    22,    23,    20,     0,
      25,    26,    27,    28,    29,     2,    12,    13,     3,     4,
       5,     6,     3,     4,     5,     6,     0,     7,     0,     8,
       0,     0,     0,     8,    16,    17,    18,    19,    20,     0,
       0,     0,     0,    24,    16,    17,    18,    19,    20,     0,
       0,     0,     0,    30,    16,    17,    18,    19,    20,     0,
      21,    16,    17,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       6,     5,     8,     8,     9,    10,    12,    13,    10,    -1,
      16,    17,    18,    19,    20,     0,    13,    14,     3,     4,
...
{
       0,    17,     0,     3,     4,     5,     6,    12,    14,    18,
      19,     5,    13,    14,    19,    19,     6,     7,     8,     9,
      10,    12,    19,    19,    15,    19,    19,    19,    19,    19,
      15
};
...
#line 45 "bison\\parser.y"
                        { printf ("\t%.10g\n", (yyvsp[-1].val)); return 0; }
#line 1343 "src/parser.cpp"
    break;

  case 6:
#line 48 "bison\\parser.y"
...
#line 49 "bison\\parser.y"
                                                { (yyval.val) = get_identifier((yyvsp[0].name))->value; }
#line 1355 "src/parser.cpp"
    break;

  case 8:
#line 50 "bison\\parser.y"
                                        { (yyval.val) = put_identifier((yyvsp[0].name))->value; }
#line 1361 "src/parser.cpp"
    break;

  case 9:
#line 51 "bison\\parser.y"
                                        { (yyval.val) = (yyvsp[0].val); put_value((yyvsp[-2].name),(yyvsp[0].val)); }
#line 1367 "src/parser.cpp"
    break;

  case 10:
#line 52 "bison\\parser.y"
                                        { (yyval.val) = get_identifier((yyvsp[-3].name))->function((yyvsp[-1].val)); }
